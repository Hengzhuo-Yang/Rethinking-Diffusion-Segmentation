"""Preprocess shared raw ISIC2018 Task 1 zips into a TSLDSeg-owned PNG cache."""
...
def preprocess(args: argparse.Namespace) -> None:
    ...
    summary = {
        ...
        "split_policy": "official ISIC2018 Task 1 training/validation/testing zip split",
        "output_size": args.output_size,
        "image_channels": 3,
        "mask_channels": 1,
        "num_seg_classes": 2,
        "image_normalization": "RGB uint8 PNG; TSLDSeg loader scales to [-1, 1]",
        "mask_normalization": "grayscale PNG thresholded at >127 to {0, 255}; TSLDSeg loader maps to binary {0, 1} and train/val [-1, 1]",
        "counts": counts,
...
def build_argparser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--output_root",
        required=True,
        help="TSLDSeg-owned ISIC2018 preprocessed output directory.",
    )
